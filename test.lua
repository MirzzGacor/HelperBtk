...
bx = GetLocal().pos.x // 32
by = GetLocal().pos.y // 32
...
SendPacketRaw(true, {type=11,value=obj.oid,x=obj.pos.x,y=obj.pos.y})
end
end
end
...
SendPacket(2,"action|input\n|text|`0 [`2Win`0] `1G`3e`5m`#s : `9"..data[1].." (gems) VS`4, `1G`3e`5m`#s : `9"..data[2].."(gems) `0[`4L`7o`5s`4e`0]")
elseif data[1] == data[2] then
SendPacket(2,"action|input\n|text|`0[`1T`3i`ee`0]`0 `1G`3e`5m`#s : `9"..data[1].." (gems) VS`0, `1G`3e`5m`#s : `9"..data[2].." `0[`1T`3i`ee`0]")
else
SendPacket(2,"action|input\n|text|`0 [`4L`7o`5s`4e`0] `1G`3e`5m`#s : `9"..data[1].." (gems) VS`4, `1G`3e`5m`#s : `9"..data[2].." `0[`2Win`0]")
end
data = {}
end

if packet:find("\nbuttonClicked|ck") then
ovlay("Taking Gems")
collect()
return true
end
